        ...
        <div className="container">
          <div id="row1" className="row valign-wrapper">
            <div id="block1" className="col l2 offset-l5 center-align ">
              <img className="moonImage" src="images/new.svg" />
            </div>
          </div>
          <div id="row2" className="row">
            <div className="col l3"></div>
            <div id="block2" className="col l2 center-align">
              <img className="moonImage" src="images/waxing-crescent.svg" />
            </div>
            <div className="col l2"></div>
            <div id="block3" className="col l2 center-align">
              <img className="moonImage" src="images/wanning-gibbous.svg" />
            </div>
            <div className="col l3"></div>
          </div>
          ...
          <div className="col l1"></div>
            <div id="block4" className="col l2  center-align">
              <img className="moonImage" src="images/waning-gibbous.svg" />
            </div>
