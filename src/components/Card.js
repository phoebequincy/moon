  ...
  render(){
    return (
      ...
      style = {modalStyling}
        ...
        id = {this.idString()}>
        <Collapsible>
          <CollapsibleItem className='active' header={this.props.phase.phase}   icon='brightness_1'>{this.props.phase.description}
          </CollapsibleItem>
          <CollapsibleItem header='Symptomatic Experience' icon='brightness_2'>{this.props.phase.symptomatic_experience}
          </CollapsibleItem>
